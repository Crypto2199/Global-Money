...
// Extended symbol list including MATIC, AVAX, LINK, UNI, LTC, ATOM, TRX, SHIB, NEAR
...
const _symMap = {
  ...
  maticusdt:"MATIC", avaxusdt:"AVAX", linkusdt:"LINK", uniusdt:"UNI",
...
async function _fallbackCryptoHTTP() {
  ...
  const symbolMap = {
    ...
    ADAUSDT:"ADA", DOGEUSDT:"DOGE", DOTUSDT:"DOT", MATICUSDT:"MATIC", AVAXUSDT:"AVAX",
